...
// DISABLED: %env_hwasan_opts=tag_in_malloc=0,tag_in_free=0     %run %t.mf 2>&1
...
// DISABLED: %env_hwasan_opts=tag_in_malloc=0,tag_in_free=1     %run %t.m 2>&1
...
// DISABLED: %env_hwasan_opts=tag_in_malloc=0,tag_in_free=0     %run %t.m 2>&1
